...
{
    private const string ApiUrl = "https://api.github.com/repos/Reisakura01/DynamicIsland.Hyper/releases/latest";
    ...
    public static async Task<(Version Version, string Url)?> CheckAsync()
    {
        try
        {
            ...
            http.DefaultRequestHeaders.UserAgent.ParseAdd("DynamicIsland.Hyper");
